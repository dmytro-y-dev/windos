...
TEST_F(TestModelRepositoryCommentaryRepository, CommentaryRepositoryInsertOneEntity)
{
  ...
  Commentary entity(0, 1, Commentary::Type::TEXT, Commentary::DateTime(2015, 12, 14, 12, 12, 0), "Test text");
...
{
  CommentaryRepository repository(m_db);
  Commentary entity(0, 1, Commentary::Type::TEXT, Commentary::DateTime(2015, 12, 14, 12, 12, 0), "1");
  Commentary updatedEntity(0, 1, Commentary::Type::TEXT, Commentary::DateTime(2005, 12, 14, 12, 12, 0), "2");
...
{
  CommentaryRepository repository(m_db);
  Commentary entity1(0, 1, Commentary::Type::TEXT, Commentary::DateTime(2015, 12, 14, 12, 12, 0), "Test text 1");
  Commentary entity2(0, 1, Commentary::Type::TEXT, Commentary::DateTime(2015, 12, 14, 23, 12, 0), "Test text 3");
  Commentary entity3(0, 1, Commentary::Type::TEXT, Commentary::DateTime(2015, 12, 14, 14, 12, 0), "Test text 2");
  Commentary entity4(0, 2, Commentary::Type::TEXT, Commentary::DateTime(2015, 12, 14, 14, 12, 0), "Test text ?");
