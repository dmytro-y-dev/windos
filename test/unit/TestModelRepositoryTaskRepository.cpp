...
TEST_F(TestModelRepositoryTaskRepository, TaskRepositoryInsertOneEntity)
{
  ...
  Task entity(0, 2, "task1", Task::Priority::NORMAL, Task::DateTime(2015, 12, 14, 12, 12, 0), Task::DateTime(2015, 12, 14, 13, 12, 0), Task::Status::COMPLETED);
...
{
  TaskRepository repository(m_db);
  Task entity(0, 1, "task1", Task::Priority::NORMAL, Task::DateTime(2015, 12, 14, 12, 12, 0), Task::DateTime(2015, 12, 14, 13, 12, 0), Task::Status::COMPLETED);
  Task updatedEntity(0, 1, "task2", Task::Priority::LOW, Task::DateTime(2013, 12, 14, 12, 12, 0), Task::DateTime(2011, 12, 14, 13, 12, 0), Task::Status::UNCOMPLETED);
...
TEST_F(TestModelRepositoryTaskRepository, TaskRepositoryFindAll)
{
  ...
  TaskRepository repository(m_db);
  Task entity1(0, 1, "task1", Task::Priority::NORMAL, Task::DateTime(2015, 12, 14, 12, 12, 0), Task::DateTime(2015, 12, 14, 13, 12, 0), Task::Status::COMPLETED);
  Task entity2(0, 1, "task3", Task::Priority::LOW, Task::DateTime(2013, 12, 14, 12, 12, 0), Task::DateTime(2011, 12, 14, 13, 12, 0), Task::Status::UNCOMPLETED);
  Task entity3(0, 1, "task2", Task::Priority::LOW, Task::DateTime(2013, 12, 14, 12, 12, 0), Task::DateTime(2011, 12, 14, 13, 12, 0), Task::Status::UNCOMPLETED);
  Task entity4(0, 2, "task4", Task::Priority::LOW, Task::DateTime(2016, 12, 14, 12, 12, 0), Task::DateTime(2017, 12, 14, 13, 12, 0), Task::Status::UNCOMPLETED);
