...
TEST_F(TestModelEntityTask, TaskGettersSetters)
{
  ...
  Task::DateTime dueDate = Task::DateTime(2015, 12, 13, 20, 14, 0);
  Task::DateTime reminderDate = Task::DateTime(2015, 12, 14, 21, 14, 0);
  ...
  Task::DateTime newDueDate = Task::DateTime(2015, 10, 13, 20, 24, 0);
  task.SetDueDate(newDueDate);
  EXPECT_TRUE(task.GetDueDate() == newDueDate);

  Task::DateTime newReminderDate = Task::DateTime(2015, 9, 13, 20, 14, 0);
